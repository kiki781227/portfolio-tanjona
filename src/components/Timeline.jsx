...
export const Timeline = ({ data }) => {
  ...
  return (
    <div className="c-space section-spacing" ref={containerRef}>
      <h2 className="text-heading">Mon Expérience Professionnelle</h2>
      <div ref={ref} className="relative pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky z-40 flex flex-col items-center self-start max-w-xs md:flex-row top-40 lg:max-w-sm md:w-full">
              <div className="absolute flex items-center justify-center w-10 h-10 rounded-full -left-3.75 bg-transparent border-2 border-white ">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-0.5 bg-linear-to-t from-black via-white to-black from-0% via-10% rounded-full"
          />
        </div>
      </div>
    </div>
